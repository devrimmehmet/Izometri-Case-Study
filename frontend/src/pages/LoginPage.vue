...
const demoGroups: DemoGroup[] = [
  {
    ...
    users: [
      ...
      { email: 'personel@izometri.com', role: 'Personnel', label: 'Personel' },
    ],
  },
  {
    tenant: 'test1',
    ...
    users: [
      ...
      { email: 'devrimmehmet@msn.com', role: 'Personnel', label: 'Personel' },
    ],
  },
  {
    tenant: 'test2',
    ...
    users: [
      ...
      { email: 'personel@test2.com', role: 'Personnel', label: 'Personel' },
    ],
  },
];
