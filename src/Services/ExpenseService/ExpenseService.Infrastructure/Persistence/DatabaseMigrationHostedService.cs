...
public sealed class DatabaseMigrationHostedService : IHostedService
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _migrationState.MarkFailed(new InvalidOperationException("Expense database migration did not complete."));
    }

    public Task StopAsync(CancellationToken cancellationToken) => Task.CompletedTask;

    private static Task EnsureMigrationHistoryTableAsync(ExpenseDbContext dbContext, CancellationToken cancellationToken)
    {
